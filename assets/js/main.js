...
const skillsDescription = {
  ...
  skill1: {
    ...
    '<p>Java to język programowania, na który w dużym stopniu stawiała moja uczelnia. Język ten jest bardzo popularny, co sprawia, że posiada także ogromną społeczność, dzięki której początkujący programiści mogą korzystać z doświadczenia innych osób.</p>' +

    '<p>Pierwszym większym projektem realizowanym w języku Java był Niezbędnik Turystyczny, opisany w poprzedniej sekcji. Obecnie stworzyłem także aplikację internetową z wykorzystaniem Spring Boot oraz Hibernate nazwaną EasySession. Będę chciał również stworzyć część webową dla Niezbędnika.</p>'
  ...
  skill4: {
    ...
    desc:
      ...
      '<p>W pracy zawodowej systemem zarządzania relacyjną bazą danych tworzonych aplikacji był Microsoft SQL Server z językiem T-SQL. Projekt EasySession posiada bazę danych MySQL, dzięki temu poznałem także ten dialekt języka SQL. Częściowo miałem do czynienia także z językiem PL/SQL oraz bazą danych Oracle, jednak pozyskiwanie danych miało miejsce głównie przez graficzny interfejs aplikacji Oracle Business Intelligence.</p>' +
  ...
  skill6: {
    ...
    desc:
      ...
      'Tworzenie aplikacji na platformę Android rozpocząłem na początku 2017 r. Niestety w programie studiów nie było ono przewidziane, dlatego uczyłem się na własną rękę.</p>' +
